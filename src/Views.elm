                ...
                [ div [ class "container-fluid" ]
                    ...
                    , div [ classList [ ( "collapse", True ), ( "navbar-collapse", True ), ( "navbar-right", True ) ], id "main-nav" ]
                        [ ul [ classList [ ( "nav", True ), ( "navbar-nav", True ) ] ]
                            [ li [ classList [ ( "active", model.route == ProfileRoute ) ] ] [ a [ href "#/" ] [ text "Profile" ] ]
                            , li [ classList [ ( "active", model.route == ExperienceRoute ) ] ] [ a [ href "#/experience" ] [ text "Experience" ] ]
                            , li [ classList [ ( "active", model.route == EducationAndTrainingRoute ) ] ] [ a [ href "#/education-and-training" ] [ text "Education & Training" ] ]
                            , li [ classList [ ( "active", model.route == SkillsRoute ) ] ] [ a [ href "#/skills" ] [ text "Skills" ] ]
                            , li [ classList [ ( "active", model.route == PortfolioRoute ) ] ] [ a [ href "#/portfolio" ] [ text "Portfolio" ] ]
                            ]
                        ]
                    ]
                ]
