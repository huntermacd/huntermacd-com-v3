        ...
        , div [ class "row" ]
            [ div [ class "col-sm-6" ]
                [ div [ class "thumbnail" ]
                    ...
                    , div [ class "caption" ]
                        [ h4 [] [ text "Treehouse" ]
                        , p [] [ text "I got my start following Treehouse's video tutorials and using what I learned to build a website for my guitar teaching business. These courses gave me everything I needed to get going with HTML, CSS, and JS and are responsible for my front-end affinity." ]
                        , a [ href "http://teamtreehouse.com/huntermacdermut" ] [ text "Click here to view my profile." ]
                        ]
                    ]
                ]
            , div [ class "col-sm-6" ]
                [ div [ class "thumbnail" ]
                    ...
                    , div [ class "caption" ]
                        [ h4 [] [ text "Code School" ]
                        , p [] [ text "As interesting libraries and frameworks emerge on the scene, I can expect a high-quality video course from Code School to follow. They do a good job of introducing you to concepts in video form and then testing your understanding of them with code challenges." ]
                        , a [ href "https://www.codeschool.com/users/353167" ] [ text "Click here to view my report card." ]
                        ]
                    ]
                ]
            ]
...
clientWorkView model =
    div []
        [ article []
            ...
            , div [ class "row" ]
                [ div [ classList [ ( "col-sm-6", True ), ( "flexbox", True ), ( "portfolio-text", True ) ] ]
                ...
                , div [ class "col-sm-6" ]
                    [ img [ classList [ ( "img-responsive", True ), ( "thumbnail", True ), ( "center-in-col", True ) ], src "../../imgs/screenshots/mc/mc-editphoto-narrow.png", alt "Narrow view of photo edit modal of Member Center." ] []
                    ]
                ]
            ...
            , div [ class "row" ]
                [ div [ class "col-sm-6" ]
                    [ img [ classList [ ( "img-responsive", True ), ( "thumbnail", True ), ( "center-in-col", True ) ], src "../../imgs/screenshots/mc/mc-changepassword-narrow.png", alt "Narrow view of change password modal of Member Center." ] []
                    ]
                , div [ classList [ ( "col-sm-6", True ), ( "flexbox", True ), ( "portfolio-text", True ) ] ]
            ...
            , div [ class "row" ]
                ...
                , div [ class "col-sm-6" ]
                    [ img [ classList [ ( "img-responsive", True ), ( "thumbnail", True ), ( "center-in-col", True ) ], src "../../imgs/screenshots/mc/mc-textalerts-narrow.png", alt "Narrow view of mobile number modal of Member Center." ] []
                    ]
                ]
            ...
            , div [ class "row" ]
                [ div [ class "col-sm-6" ]
                    [ img [ classList [ ( "img-responsive", True ), ( "thumbnail", True ), ( "center-in-col", True ) ], src "../../imgs/screenshots/mc/mc-accordion-narrow.png", alt "Narrow view of accordion nav of Member Center." ] []
                    ]
                , div [ classList [ ( "col-sm-6", True ), ( "flexbox", True ), ( "portfolio-text", True ) ] ]
                    [ p [] [ text "The accordion nav shown here is replaced with more traditional horizontal navigation on wider screens." ]
                    , br [] []
        ...
        , article []
            ...
            , div [ class "row" ]
                ...
                , div [ class "col-sm-6" ]
                    [ img [ classList [ ( "img-responsive", True ), ( "thumbnail", True ), ( "center-in-col", True ) ], src "../../imgs/screenshots/calc/calc-narrow.png", alt "Narrow view of Caktus salary calculator." ] []
                    ]
                ]
    ...
    div []
        [ article []
            ...
            , div [ class "row" ]
                [ div [ classList [ ( "col-sm-6", True ), ( "flexbox", True ), ( "portfolio-text", True ) ] ]
                    ...
                    , br [] []
                    , p [] [ text "I used the Swig templating engine for the front-end, Node/Express for the server-side code, and MongoDB as a data-store. I never quite developed as a blogger, however, and have since replaced this site with a new version." ]
                    ]
                , div [ class "col-sm-6" ]
                    [ img [ classList [ ( "img-responsive", True ), ( "thumbnail", True ), ( "center-in-col", True ) ], src "../../imgs/screenshots/hm-com/hm-com-v1-narrow.gif", alt "Narrow view of the blog version of my website." ] []
                    ]
                ]
            , img [ classList [ ( "img-responsive", True ), ( "thumbnail", True ), ( "center-in-col", True ) ], src "../../imgs/screenshots/hm-com/hm-com-v2-wide.gif", alt "Wide view of the React/Redux version of my website." ] []
            , div [ class "row" ]
                [ div [ classList [ ( "col-sm-6", True ), ( "flexbox", True ), ( "portfolio-text", True ) ] ]
                ...
                , div [ class "col-sm-6" ]
                    [ img [ classList [ ( "img-responsive", True ), ( "thumbnail", True ), ( "center-in-col", True ) ], src "../../imgs/screenshots/hm-com/hm-com-v2-narrow.png", alt "Narrow view of the React/Redux version of my website." ] []
                    ]
                ]
            , p [] [ text "(Version 1)" ]
            , p []
        ...
        , article []
            ...
            , div [ class "row" ]
                ...
                , div [ class "col-sm-6" ]
                    [ img [ classList [ ( "img-responsive", True ), ( "thumbnail", True ), ( "center-in-col", True ) ], src "../../imgs/screenshots/rag-and-bone-narrow.gif", alt "Screenshot of Rag & Bone, a cute white noise maker." ] []
                    ]
                ]
            , p []
                [ span [ classList [ ( "fa", True ), ( "fa-external-link", True ) ] ] []
        ...
        , article []
            ...
            , div [ class "row" ]
                [ div [ class "col-sm-6" ]
                    [ img [ classList [ ( "img-responsive", True ), ( "thumbnail", True ), ( "center-in-col", True ) ], src "../../imgs/screenshots/dont-touch-no-no-narrow.gif", alt "Screenshot of Don't Touch, No, No, an HTML5 bullet-hell game built with Phaser." ] []
                    ]
                , div [ classList [ ( "col-sm-6", True ), ( "flexbox", True ), ( "portfolio-text", True ) ] ]
        ...
        , article []
            ...
            , div [ class "row" ]
                ...
                , div [ class "col-sm-6" ]
                    [ img [ classList [ ( "img-responsive", True ), ( "thumbnail", True ), ( "center-in-col", True ) ], src "../../imgs/screenshots/synth-narrow.png", alt "Screenshot of Synth, an experiment in audio synthesis using the Web Audio API." ] []
                    ]
                ]
            , p []
                [ span [ classList [ ( "fa", True ), ( "fa-external-link", True ) ] ] []
        ...
        , article []
            ...
            , div [ class "row" ]
                [ div [ class "col-sm-6" ]
                    [ img [ classList [ ( "img-responsive", True ), ( "thumbnail", True ), ( "center-in-col", True ) ], src "../../imgs/screenshots/ncpp/ncpp-narrow.png", alt "Narrow view of North Carolina Pipper Peeper, a bird-watching app." ] []
                    ]
                , div [ classList [ ( "col-sm-6", True ), ( "flexbox", True ), ( "portfolio-text", True ) ] ]
