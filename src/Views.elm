...
experienceView model =
    section [ class "container-fluid" ]
        [ h3 [] [ text "Experience" ]
        , h4 [] [ text "Web Developer, Cox Media Group; Remote — September 2014-November 2016" ]
        ...
        , hr [] []
        , h4 [] [ text "Web Developer, Caktus Group; Durham, NC — May 2014-Present" ]
        ...
        , hr [] []
        , h4 [] [ text "Guitar Instructor, Self-Employed; Apex, NC — 2007-2014" ]
        , img [ class "img-responsive", src "../../imgs/logos/acpg-logo.png", alt "Anyone Can Play Guitar logo." ] []
...
educationAndTrainingView model =
    section [ class "container-fluid" ]
        ...
        , div [ class "row" ]
            [ div [ classList [ ( "col-sm-6", True ), ( "col-md-4", True ) ] ]
                [ div [ class "thumbnail" ]
...
skillsView model =
    section [ class "container-fluid" ]
        ...
        , div []
            [ div []
                [ p [] [ text "Languages" ]
                , img [ class "img-responsive", src "../../imgs/misc/skills-bar-chart.png", alt "Bar chart showing years of experience with various programming languages." ] []
                ]
            , div []
...
clientWorkView model =
    div []
        [ article []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/mc/mc-youraccount-wide.png", alt "Wide view of Your Account page of Member Center." ] []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/mc/mc-editphoto-narrow.png", alt "Narrow view of photo edit modal of Member Center." ] []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/mc/mc-changepassword-narrow.png", alt "Narrow view of change password modal of Member Center." ] []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/mc/mc-textalerts-wide.png", alt "Wide view of Text Alerts page of Member Center." ] []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/mc/mc-textalerts-narrow.png", alt "Narrow view of mobile number modal of Member Center." ] []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/mc/mc-accordion-narrow.png", alt "Narrow view of accordion nav of Member Center." ] []
            , p [] [ text "The accordion nav shown above is replaced with more traditional horizontal navigation on wider screens." ]
            , img [ class "img-responsive", src "../../imgs/screenshots/mc/mc-highschoolsports-wide.png", alt "Wide view of high school sports widget of Member Center." ] []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/mc/mc-ourproducts-wide.png", alt "Wide view of Our Products page of Member Center." ] []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/mc/mc-newsletters-wide.png", alt "Wide view of Newsletters page of Member Center." ] []
        ...
        , article []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/calc/calc-wide.png", alt "Wide view of Caktus salary calculator." ] []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/calc/calc-narrow.png", alt "Narrow view of Caktus salary calculator." ] []
        ...
        , article []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/duckling/duckling-wide.png", alt "Duckling logo." ] []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/duckling/duckling-widget-wide.png", alt "Duckling widget on PyOhio conference website." ] []
...
sideProjectView model =
    div []
        ...
        , article []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/hm-com/hm-com-v1-wide.png", alt "Wide view of the blog version of my website." ] []
            , p [] [ text "My personal website and blog was my first experience building and deploying a full-stack JavaScript application." ]
            , img [ class "img-responsive", src "../../imgs/screenshots/hm-com/hm-com-v1-narrow.gif", alt "Narrow view of the blog version of my website." ] []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/hm-com/hm-com-v2-narrow.png", alt "Narrow view of the React/Redux version of my website." ] []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/hm-com/hm-com-v2-wide.gif", alt "Wide view of the React/Redux version of my website." ] []
        ...
        , article []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/elm-memory-wide.png", alt "Screenshot of Elm Memory, a memory-matching game written in Elm." ] []
        ...
        , article []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/rag-and-bone-narrow.gif", alt "Screenshot of Rag & Bone, a cute white noise maker." ] []
        ...
        , article []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/dont-touch-no-no-narrow.gif", alt "Screenshot of Don't Touch, No, No, an HTML5 bullet-hell game built with Phaser." ] []
        ...
        , article []
            ...
            , p [] [ text "Frameworks/Libraries/Etc. used: Web Audio API" ]
            , img [ class "img-responsive", src "../../imgs/screenshots/synth-narrow.png", alt "Screenshot of Synth, an experiment in audio synthesis using the Web Audio API." ] []
        ...
        , article []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/ncpp/ncpp-wide.png", alt "Wide view of North Carolina Pipper Peeper, a bird-watching app." ] []
            ...
            , img [ class "img-responsive", src "../../imgs/screenshots/ncpp/ncpp-narrow.png", alt "Narrow view of North Carolina Pipper Peeper, a bird-watching app." ] []
