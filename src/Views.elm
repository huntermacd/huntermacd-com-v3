                ...
                , div [ classList [ ( "collapse", True ), ( "navbar-collapse", True ), ( "navbar-right", True ) ], id "main-nav" ]
                    [ ul [ classList [ ( "nav", True ), ( "navbar-nav", True ) ] ]
                        [ li [ classList [ ( "active", model.route == ProfileRoute ) ] ]
                            [ a [ href "#/", attribute "data-toggle" "collapse", attribute "data-target" ".navbar-collapse.in" ] [ text "Profile" ] ]
                        , li [ classList [ ( "active", model.route == ExperienceRoute ) ] ]
                            [ a [ href "#/experience", attribute "data-toggle" "collapse", attribute "data-target" ".navbar-collapse.in" ] [ text "Experience" ] ]
                        , li [ classList [ ( "active", model.route == EducationAndTrainingRoute ) ] ]
                            [ a [ href "#/education-and-training", attribute "data-toggle" "collapse", attribute "data-target" ".navbar-collapse.in" ] [ text "Education & Training" ] ]
                        , li [ classList [ ( "active", model.route == SkillsRoute ) ] ]
                            [ a [ href "#/skills", attribute "data-toggle" "collapse", attribute "data-target" ".navbar-collapse.in" ] [ text "Skills" ] ]
                        , li [ classList [ ( "active", model.route == PortfolioRoute ) ] ]
                            [ a [ href "#/portfolio", attribute "data-toggle" "collapse", attribute "data-target" ".navbar-collapse.in" ] [ text "Portfolio" ] ]
                        ]
                    ]
                ]
            ]
